# Análise de Importância de Features para Exercise_Recommendation
...
N_TOP = 15  # quantas features destacar no gráfico
...
print(f"\n  Colunas removidas:")
print(f"    - Data leakage: Health_Risk, Heart_Disease_Risk, Diabetes_Risk, Predicted_Insurance_Cost")
print(f"    - Viés espúrio: Gender (não deve influenciar recomendação de exercício)")
...
if len(top_num_features) > 0:
    ...
    print("\nCorrelação absoluta com Exercise_Recommendation:")
